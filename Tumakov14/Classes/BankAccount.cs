...
namespace Tumakov14.Classes
{
    ...
    public class BankAccount  
    {
        ...
        {
            Console.WriteLine($"Номер счета: {AccNum}");
            Console.WriteLine($"Держатель счёта: {FullName}");
            Console.WriteLine($"Баланс: {balance}");
            Console.WriteLine($"Дата создания: {created:dd.MM.yyyy HH:mm}");
        }
